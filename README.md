...
![alt promo](docs/assets/readme-promotional.png)
...
|-------|---------------------|---------------------------------------------------------|-------------------------------------------------------------------------|
| 🟢    | Dark mode           | Latest deployment of the template here on GitHub pages. | [Preview](https://www.adarshshukla.in/#about)     |
| 🟣    | Neon Voilet         | An example of how the template can be customized.       | [Preview](https://www.adarshshukla.in/#about)    |
| 🔵    | Emerald             | Another example of how the template can be customized.  | [Preview](https://www.adarshshukla.in/#about) |
...
1. Clone the repo:
```
git clone https://github.com/The-AdarshShukla/Myportfolio
```
...
This template was created by and is maintained by **[Adarsh Shukla](https://www.adarshshukla.in)**.
